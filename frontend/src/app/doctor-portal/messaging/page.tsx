...
export default function DoctorMessagingPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Please log in to access the doctor portal.</p>
        </div>
      </div>
    )
  }
  ...
  const fetchConversations = async () => {
    try {
      ...
      const response = await fetch('/api/doctor-portal/messaging/conversations', {
        method: 'GET',
        headers: {
      ...
      if (data.success) {
        ...
        // Fallback: try direct backend call
  ...
  const fetchConversationsFromBackend = async () => {
    try {
      ...
      console.error('Backend fallback also failed:', error)
    }
  }
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/doctor-portal/messaging/send', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      if (!contentType || !contentType.includes('application/json')) {
        console.error('Response is not JSON:', contentType)
        alert('Failed to send message: Invalid response format')
        return
      }
      ...
      <div className="bg-white shadow-lg border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-6">
            ...
            <p className="text-gray-600 mt-2">Communicate with your patients after confirmed appointments</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[700px]">
          ...
          <div className="lg:col-span-1 bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
              <h2 className="text-xl font-bold text-gray-900">Patient Conversations</h2>
            ...
            <div className="overflow-y-auto h-[580px]">
              {conversations.length === 0 ? (
                <div className="p-8 text-center text-gray-500">
                  ...
                  <p className="text-sm text-gray-500 mb-1">Patients will appear here after confirmed appointments</p>
                  <p className="text-xs text-gray-400">Make sure you're logged in as a doctor</p>
                </div>
              ) : (
            ...
            {selectedConversation ? (
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-50">
                  {messages.length === 0 ? (
                    <div className="text-center text-gray-500 py-12">
                      ...
                      <p className="text-sm text-gray-500">Start the conversation with your patient</p>
                    </div>
                  ) : (
                ...
                <div className="p-6 border-t border-gray-200 bg-white">
                  ...
                  <div className="flex items-end space-x-3">
                    ...
                    <div className="flex-1 relative">
                      ...
                      />
                      <button className="absolute right-3 top-1/2 transform -translate-y-1/2 p-1 text-gray-500 hover:text-blue-600 transition-colors">
                    ...
                    <button
                      ...
                      className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl hover:from-blue-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2 shadow-lg transition-all duration-200 transform hover:scale-105"
                    >
                      {sending || uploading ? (
              ...
              <div className="flex-1 flex items-center justify-center text-gray-500 bg-gradient-to-br from-gray-50 to-gray-100">
                <div className="text-center p-8">
                  ...
                  <p className="text-lg text-gray-500 mb-2">Choose a patient to start messaging</p>
